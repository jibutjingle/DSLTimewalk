...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP_Dissolve"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				Color += _DissolveColor.rgb * step(dissolveNoise, _DissolveAmount + _DissolveWidth);
	...
	CustomEditor "Reallusion.Import.DissolveASEShaderGUI"
